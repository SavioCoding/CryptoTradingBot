...
class MomentumTrader(Trader.Trader):
    ...
    def generate_trading_signals(self):
        momentumStrat = Momentum(None, None, self.price_data.copy(), self.symbols)
...
if __name__ == "__main__":  # only if we run MACtrader.py as a script, please do the following:
    ...
    trader = MomentumTrader(symbols=symbols, params_dict = params_dict, usdtunits=units, testnet_client=testnet_client,
