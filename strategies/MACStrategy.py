...
class MAC(Strategy):
    ...
    def optimise_strategy(self, short_windows, long_windows, training):
        ...
        for i in range(len(self.symbols)):
            ...
            print(f"Performance of {symbols[i]}:")
            print("Top 5 Sharpe Ratio: \n")
            print(combine_results.nlargest(5, "sharpe"))
            print("\n")
            params_dict[symbols[i]] = (combine_results.nlargest(1, "sharpe").iloc[0,:][0], combine_results.nlargest(1, "sharpe").iloc[0,:][1])
        return params_dict
...
if __name__ == "__main__":
    ...
    training_period = ("2020-01-01", "2022-05-31")
    ...
    macStrat.backtest(params_dict, True)
